...
export const ScrambleWords = () => {
  ...
  const {
    words,
    // currentWord, // Not used in render directly except for debug or logic inside reducer
    scrambledWord,
    guess,
    points,
    errorCounter,
  ...
  // Update scrambled word when current word changes
  /* useEffect(() => {
    if (currentWord) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="w-full max-w-md mx-auto">
          ...
          <p className="text-gray-600">Has completado todas las palabras.</p>
          <br />
          <div>Puntaje Final: {points}</div>
          <br />
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md mx-auto">
        ...
        <div className="text-center mt-6">
          ...
          <p className="text-sm text-gray-500 mt-2">{GAME_WORDS.join(", ")}</p>
        </div>
      </div>
    </div>
  );
