...
const HeroGridCard = ({ hero }: Props) => {
  ...
  const statsMultiplicados = statsOriginales.map((valor) => valor * 10);
  return (
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="space-y-1">
            ...
            <Progress value={statsMultiplicados[0]} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={statsMultiplicados[1]} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={statsMultiplicados[2]} className="h-2" />
          </div>
          <div className="space-y-1">
            <div className="flex items-center gap-1">
            ...
            <Progress value={statsMultiplicados[3]} className="h-2" />
          </div>
        </div>
